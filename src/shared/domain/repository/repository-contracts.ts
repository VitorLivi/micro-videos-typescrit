...
class SearchParams {
  ...
  constructor(props: SearchProps = {}) {
    ...
    props.per_page = props.per_page;
    props.sort = props.sort;
    props.sort_dir = props.sort_dir;
  ...
  private set per_page(value: number) {
    const _per_page = +value;

    if (Number.isNaN(_per_page) || _per_page < 1 || parseInt(_per_page as any) !== _per_page) {
