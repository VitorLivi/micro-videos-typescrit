...
describe('CategoryValidator Tests', () => {
    let validator;
    beforeEach(() => {
        validator = category_validators_1.CategoryValidatorFactory.create();
    });
    ...
    test('valid cases for fields', () => {
        ...
        arrange.forEach((data) => {
            ...
            expect(validator.validatedData).toStrictEqual(new category_validators_1.CategoryRules(data));
        });
    });
});
