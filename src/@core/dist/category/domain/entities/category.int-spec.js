...
describe("Category Integration Tests", () => {
    describe("create method", () => {
        ...
        it("should a invalid category using description property", () => {
            expect(() => new category_1.Category({ description: 5 })).containsErrorMessages({
                description: ["description must be a string"],
            });
        });
        it("should a invalid category using is_active property", () => {
            expect(() => new category_1.Category({ is_active: 5 })).containsErrorMessages({
    ...
    describe("update method", () => {
        ...
        it("should a invalid category using description property", () => {
            const category = new category_1.Category({ name: "Movie" });
            expect(() => category.update(null, 5)).containsErrorMessages({
                description: ["description must be a string"],
            });
        });
        it("should a valid category", () => {
