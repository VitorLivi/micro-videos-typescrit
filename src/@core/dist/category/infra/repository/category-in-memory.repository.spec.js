...
describe("CategoryInMemoryRepository", () => {
    let repository;
    beforeEach(() => (repository = new category_in_memory_repository_1.CategoryInMemoryRepository()));
    ...
    it('should sort by created_at when sort param is null', async () => {
        ...
        const items = [
            ...
            new category_1.Category({ name: 'TEST', created_at: new Date(created_at.getTime() + 100) }),
